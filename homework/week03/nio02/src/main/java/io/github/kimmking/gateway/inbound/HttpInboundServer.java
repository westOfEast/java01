...
public class HttpInboundServer {
    ...
    public HttpInboundServer(int port, String proxyServer) throws IOException {
//        LogBackConfigLoader.load(System.getProperty("user.dir")+ File.separator+"logback-log.xml");
//        logger = LoggerFactory.getLogger(HttpInboundServer.class);
        this.port=port;
